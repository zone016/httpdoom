...
internal static class Program
{
    ...
    private static readonly List<HttpDoomResponse> Responses = [];
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        var rootCommand =
            ...
            {
                new Option<string[]>(["--headers", "-H"])
                {
                    Description = "Headers to be used in every request"
                },
                new Option<List<int>>(["--ports", "-p"], parseArgument: result => result.Tokens[0]
                    .Value
                    .Trim()
